...
Library for adding snapping to a d3 [brush](https://github.com/d3/d3-brush).

[![npm version](https://badge.fury.io/js/d3-brush-snapping.svg)](https://badge.fury.io/js/d3-brush-snapping)


# Example
[See it in action here](https://caldwellc.github.io/d3-brush-snapping/)

![Snapping Example](https://github.com/caldwellc/d3-brush-snapping/blob/main/snapping.gif?raw=true)
